...
SearchSite -> Find all pages of result -> Find all Products on each page -> Parse Products -> DB Dump

All you should really have to do in order to make an alerting system, then, is specify to the interface how to parse the html at each step of this process (What tags contain links to other pages, which tags contain product information, etc.)
